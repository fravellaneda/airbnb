...
This repository is part of the project of the udacity data scientist nanodegree program. The data from Airbnb has taken from Kaggle link available [here](https://www.kaggle.com/airbnb/seattle/data). Thanks for read, if you have comments or advices please contact me at the email fr_avellaneda@hotmail.com.
